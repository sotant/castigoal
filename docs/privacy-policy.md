...
Sustituye esta seccion por tu nombre legal o el de tu empresa y un email real de soporte antes de publicar.
...
Los datos se conservan mientras la cuenta permanezca activa o hasta que el usuario solicite su eliminacion desde la propia app.

## Derechos del usuario

El usuario puede:

- revisar y actualizar sus datos dentro de la app;
- vaciar sus datos de uso;
- eliminar su cuenta completa desde Ajustes.

Cuando el usuario elimina su cuenta, se solicita el borrado de su usuario en Supabase y de los datos vinculados mediante relaciones en cascada.

## Contacto

Sustituye esta linea por tu email de soporte publico antes de publicar en Google Play.
